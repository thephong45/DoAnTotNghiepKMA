            ...
            <div class="col-md-12">
                <form method="post" action="{{ route('postUser') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" name="password" class="form-control" placeholder="Enter password" disabled>
                    </div>
                    <div class="form-group">
                        <label>Confirm Password</label>
                        <input type="password" name="confirm_password" class="form-control" placeholder="Enter Confirm Password" disabled>
                    </div>
