                ...
                <div class="masthead-content text-white py-5 py-md-0">
                    ...
                    <div class="input-group input-group-newsletter">
                        <div class="input-group-append" >
                            <button class="btn btn-success" type="button" onclick="window.open('{{ route('connection') }}', '_self')" style="border-top-left-radius: 3px; border-bottom-left-radius: 3px; margin-left: 50px;">Connection!</button>
...
<div class="social-icons" style="margin:30px 80px 80px 10px">
    <form method="post" action="{{ url('/saveOauth2') }}">
        ...
        <ul class="list-unstyled text-center mb-0 custom-css">
            ...
            <li class="list-unstyled-item" style="margin-bottom: 25px !important;">
                <div class="input-group input-group-newsletter">
                    <label for="" class="oauth2">Token: </label>
                    <input type="checkbox" name="terms" hidden="true" checked>
                    <input required type="text" name="client_secret" class="form-control" placeholder="Enter Client Secret..." aria-label="Enter Client Secret..." aria-describedby="basic-addon" style="height: auto;font-size: 1rem;padding: 1rem; margin-left: 10px;border-top-left-radius: 5px; border-bottom-left-radius: 5px;" value="{{ htmlspecialchars($token) }}">
                </div>
            </li>
